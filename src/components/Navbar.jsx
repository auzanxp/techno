      ...
      <div className="py-5 lg:py-0 container mx-auto px-6 flex items-center justify-between">
        ...
        <div>
          <button
            ...
            className={`${
              show ? "block" : ""
            } flex bg-[#D2E4F7] p-2 rounded-md font-medium gap-2 lg:hidden text-primary hover:text-gray-700`}
          >
            <svg
          ...
          <div id="menu" className={` ${show ? "" : "hidden"} lg:block `}>
            <button
              onClick={() => setShow(!show)}
              className={`block lg:hidden bg-[#D2E4F7] p-2 rounded-md text-gray-500 hover:text-gray-700 focus:text-gray-700 fixed focus:outline-none focus:ring-2 focus:ring-gray-500 z-30 top-0 right-12 mt-6`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={24}
